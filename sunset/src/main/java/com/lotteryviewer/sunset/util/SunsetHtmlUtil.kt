...
object SunsetHtmlUtil {
    ...
    private var getSunInfo = ("javascript:function getSunInfo() {"
            + "     var rootTable = document.getElementById('richurimo_table');"
            ...
            + "             finalResult += tds[0].innerText;"
            + "             finalResult += '${SunsetDataUtil.SPLIT}';"
            + "             finalResult += tds[1].innerText;"
            + "             finalResult += '${SunsetDataUtil.SPLIT}';"
            + "             finalResult += tds[2].innerText;"
            + "             finalResult += '${SunsetDataUtil.SPLIT}';"
            + "             finalResult += tds[3].innerText;"
            + "             finalResult += '${SunsetDataUtil.SPLIT}';"
            + "             finalResult += tds[4].innerText;"
            + "             finalResult += '${SunsetDataUtil.SPLIT}';"
            + "             finalResult += tds[5].innerText;"
            + "             finalResult += '${SunsetDataUtil.SPLIT}';"
            + "             finalResult += tds[6].innerText;"
            + "             break;"
            + "         }"
            + "     }"
            + "     return finalResult;"
